...
每个正式任务都应在这里生成一份项目任务说明，记录目标、范围、验收标准和约束。

推荐命名：

- `YYYY-MM-DD-<scope>-project-task.md`
...
- `2026-03-07`: `docs/project/tasks/20260307-005156-web-step-dsl-project-task.md` - Web step DSL字段约束状态机示例集合设计
...
- `2026-03-07`: `docs/project/tasks/20260307-091146-step-project-task.md` - 远程step控制协议
...
- `2026-03-07`: `docs/project/tasks/20260307-095018-smoke-run-project-task.md` - 真实浏览器交互 smoke run 扩展

- `2026-03-07`: `docs/project/tasks/20260307-100206-control-plane-postgresql-project-task.md` - control-plane PostgreSQL持久化骨架
...
- `2026-03-07`: `docs/project/tasks/20260307-191725-control-plane-post-api-v1-runs-project-task.md` - control-plane 公开 POST /api/v1/runs
